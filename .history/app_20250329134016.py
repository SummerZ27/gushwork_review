...
rewriter_prompt_template = (
    ...
    "4. Preserve as much of the original style and meaning as possible. Don't feel the need to paraphrase, keep the original wording if there are no feedbacks to change them. Kepp the Sources and Citations and Notations exactly the same.\n\n"
    "ORIGINAL BLOG POST:\n"
    "---\n{original}\n---\n\n"
    "REVIEWER FEEDBACKS:\n"
    "---\n1) {f1}\n\n2) {f2}\n\n3) {f3}\n---\n\n"
