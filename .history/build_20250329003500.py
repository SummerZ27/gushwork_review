...
# ------------------------------------------------------------------------------
BLOG_FILE_PATH = "my_blog_post.txt"  # Example file name
...
def call_claude_api(prompt, api_key, model="claude-v1.3", max_tokens_to_sample=1000):
    ...
    headers = {
        "x-api-key": "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",
